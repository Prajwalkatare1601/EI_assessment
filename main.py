"""
Name : Prajwal G K
Roll No : 20ETCS002093

PROBLEM STATEMENT : Create a simple To-Do List Manager where users can add tasks, 
mark them as completed, and delete them. The user should also have the option to view all tasks or 
filter them based on their completion status.

Behavioral Pattern: Memento Pattern (undo or redo actions)
Creational Pattern: Builder Pattern (due date or tags)
"""
